...
- 🐘 **PHP-Apache** with custom `php.ini`
...
The aproach for the modern version was to be able to create not only PHP projects and also node projects (vue, etc.)
...
│   ├── _dashboard/      # internal dashboard (Vue + PHP)
