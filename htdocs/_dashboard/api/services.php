...
$env = [
    'NGINX_HTTP_PORT' => env_str('NGINX_HTTP_PORT','80'),
...
$targets = [
    ...
    ['name'=>'nginx',  'host'=>env_str('NGINX_CONTAINER','ftxampp_nginx'),    'port'=>80],
    ['name'=>'php-fpm','host'=>env_str('PHPFPM_CONTAINER','ftxampp_phpfpm'),  'port'=>9000],
